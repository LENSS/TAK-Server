...
/**
 * The TAK trust chain retriever.
 */
public class TakTrustChainRetriever implements TakTrustChainRetrieverInterface {
     ...
     *                  {@code null}.
     */
    TakTrustChainRetriever(final EntityStatementRetriever retriever) {
