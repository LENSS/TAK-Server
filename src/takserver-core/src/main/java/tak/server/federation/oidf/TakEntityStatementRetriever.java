 ...
 * strategies.
 */
public class TakEntityStatementRetriever implements EntityStatementRetriever {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TakEntityStatementRetriever.class);
     ...
     * timeout settings.
     */
    public TakEntityStatementRetriever() {
     ...
     */
    public TakEntityStatementRetriever(final int httpConnectTimeoutMs,
     ...
     *                          {@code null}.
     */
    public TakEntityStatementRetriever(final HTTPRequestSender httpRequestSender) {
