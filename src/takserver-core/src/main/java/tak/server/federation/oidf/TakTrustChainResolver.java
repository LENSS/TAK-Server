 ...
 * </ul>
 */
public class TakTrustChainResolver {
     ...
     */
    public TakTrustChainResolver(final EntityID trustAnchor) {
     ...
     */
    public TakTrustChainResolver(final Map<EntityID, JWKSet> trustAnchors,
    ...
    public TrustChainSet resolveTrustChains(final EntityID target,
        ...
        TakTrustChainRetrieverInterface retriever = new TakTrustChainRetriever(statementRetriever, constraints);
