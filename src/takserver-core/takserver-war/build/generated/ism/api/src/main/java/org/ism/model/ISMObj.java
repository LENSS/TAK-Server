 ...
 */
@JsonPropertyOrder({
  ISMObj.JSON_PROPERTY_CLASSIFICATION,
  ISMObj.JSON_PROPERTY_SCICONTROLS,
  ISMObj.JSON_PROPERTY_DISSEMINATIONCONTROLS,
  ISMObj.JSON_PROPERTY_RELEASABLETO,
  ISMObj.JSON_PROPERTY_PROGRAMNICKNAMES,
  ISMObj.JSON_PROPERTY_NONICMARKINGS,
  ISMObj.JSON_PROPERTY_FGISOURCEOPEN,
...
public class ISMObj {
  ...
  public ISMObj classification(List<String> classification) {
    
    this.classification = classification;
    return this;
  }

  public ISMObj addClassificationItem(String classificationItem) {
  ...
  **/
  ...
  public ISMObj scicontrols(List<String> scicontrols) {
    
    this.scicontrols = scicontrols;
    return this;
  }

  public ISMObj addScicontrolsItem(String scicontrolsItem) {
  ...
  **/
  ...
  public ISMObj disseminationcontrols(List<String> disseminationcontrols) {
    
    this.disseminationcontrols = disseminationcontrols;
    return this;
  }

  public ISMObj addDisseminationcontrolsItem(String disseminationcontrolsItem) {
  ...
  **/
  ...
  public ISMObj releasableto(List<String> releasableto) {
    
    this.releasableto = releasableto;
    return this;
  }

  public ISMObj addReleasabletoItem(String releasabletoItem) {
  ...
  **/
  ...
  public ISMObj programnicknames(List<String> programnicknames) {
    
    this.programnicknames = programnicknames;
    return this;
  }

  public ISMObj addProgramnicknamesItem(String programnicknamesItem) {
  ...
  **/
  ...
  public ISMObj nonicmarkings(List<String> nonicmarkings) {
    
    this.nonicmarkings = nonicmarkings;
    return this;
  }

  public ISMObj addNonicmarkingsItem(String nonicmarkingsItem) {
  ...
  **/
  ...
  public ISMObj fgisourceopen(List<String> fgisourceopen) {
    
    this.fgisourceopen = fgisourceopen;
    return this;
  }

  public ISMObj addFgisourceopenItem(String fgisourceopenItem) {
  ...
  **/
  ...
  public ISMObj fgisourceprotected(List<String> fgisourceprotected) {
    
    this.fgisourceprotected = fgisourceprotected;
    return this;
  }

  public ISMObj addFgisourceprotectedItem(String fgisourceprotectedItem) {
  ...
  **/
  ...
  public ISMObj ownerproducer(List<String> ownerproducer) {
    
    this.ownerproducer = ownerproducer;
    return this;
  }

  public ISMObj addOwnerproducerItem(String ownerproducerItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ISMObj isMObj = (ISMObj) o;
    return Objects.equals(this.classification, isMObj.classification) &&
        Objects.equals(this.scicontrols, isMObj.scicontrols) &&
        Objects.equals(this.disseminationcontrols, isMObj.disseminationcontrols) &&
        Objects.equals(this.releasableto, isMObj.releasableto) &&
        Objects.equals(this.programnicknames, isMObj.programnicknames) &&
        Objects.equals(this.nonicmarkings, isMObj.nonicmarkings) &&
        Objects.equals(this.fgisourceopen, isMObj.fgisourceopen) &&
        Objects.equals(this.fgisourceprotected, isMObj.fgisourceprotected) &&
        Objects.equals(this.ownerproducer, isMObj.ownerproducer);
  }
